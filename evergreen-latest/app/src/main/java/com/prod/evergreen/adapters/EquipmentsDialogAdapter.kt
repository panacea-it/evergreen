...
class EquipmentsDialogAdapter(private val items: List<Data>, private val onItemClick: (Data) -> Unit) : RecyclerView.Adapter<EquipmentsDialogAdapter.ItemViewHolder>() {
