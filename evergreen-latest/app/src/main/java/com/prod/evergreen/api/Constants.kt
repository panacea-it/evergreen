...
class Constants {
    ...
    companion object{
        ...
        const val CREATE_SERVICE_REPORT = "user/createServiceReport"
        const val UPDATE_SERVICE_REPORT = "user/updateServiceReport"
        const val DELETE_SERVICE_REPORT = "user/deleteServiceReport"
        const val GET_ALL_SERVICE_REPORTS = "user/getAllServiceReports"
        const val GET_SERVICE_REPORT_DETAILS = "user/getServiceReportDetails"
        const val DOWNLOAD_SERVICE_REPORT_PDF = "user/downloadServiceReportPdf"
        const val GET_SERVICE_REPORT_PREFILL = "user/getServiceReportPrefill"
